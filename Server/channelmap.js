...
(function () {
    ...
    channelMap.channelName = function(s) {
      var numbers = ["zero", "one", "two", "three", "four", "five", "six",
                     "seven", "eight", "nine"];
      for(var i = 0; i < numbers.length; i++) {
        s = s.replace(i.toString(), numbers[i]);
      }
      return s;
    }

    channelMap.theList = ["Virgin Media Previews","BBC One","BBC Two","ITV","Channel Four","Channel Five","BBC Three","BBC Four",
